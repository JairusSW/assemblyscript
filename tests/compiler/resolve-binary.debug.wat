(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 11248))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 44016))
 (global $~lib/memory/__heap_base i32 (i32.const 44016))
 (memory $0 1)
